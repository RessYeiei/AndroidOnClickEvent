...
public class Option5Activity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        findViewById(R.id.bt_back_5).setOnClickListener(new InnerOnClickListener());
        findViewById(R.id.bt_next_5).setOnClickListener(new InnerOnClickListener());
    }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.bt_back_5:
                    ...
                    break;
                case R.id.bt_next_5:
                    Intent next = new Intent(Option5Activity.this,Option1Activity.class);
                    startActivity(next);
                    finish();
                    break;
            }
